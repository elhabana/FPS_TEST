    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings input) : SV_Target
            {
                ...
                float pattern = saturate(frac(input.positionOS.y * 1.5) * 0.7 + noise * 0.3);
                ...
                half3 energy = _EdgeColor.rgb * (0.75 + 0.25 * sin(input.positionOS.y * 100.0 + _Time.y * 10.0));
